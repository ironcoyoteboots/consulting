...
export const metadata = {
  ...
  description: "Helping leaders and teams align vision, process, and delivery for predictable results.",
};
  ...
  return (
    <html lang="en">
      <body className="min-h-screen flex flex-col">
        ...
        {/* SPACER so content starts directly under the fixed header (no extra white gap) */}
        <div className="h-16" />
